...
if ! [[ -x "$(command -v kotlinc)" ]]; then
    echo "Installing kotlin compiler 1.3.61"
    curl -o kotlin-compiler.zip -L https://github.com/JetBrains/kotlin/releases/download/v1.3.61/kotlin-compiler-1.3.61.zip
